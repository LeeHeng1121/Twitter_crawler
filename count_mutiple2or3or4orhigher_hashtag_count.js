...
if(json.entities.hashtags.length ==2){
two_ht+=1;
console.log("two_ht:" + two_ht);
console.log("three_ht:" + three_ht);
console.log("four_ht:" + four_ht);
console.log("more_ht:" + more_ht);
}
else if(json.entities.hashtags.length ==3){
three_ht+=1;
console.log("two_ht:" + two_ht);
console.log("three_ht:" + three_ht);
console.log("four_ht:" + four_ht);
...
else if(json.entities.hashtags.length ==4){
four_ht+=1;
console.log("two_ht:" + two_ht);
console.log("three_ht:" + three_ht);
console.log("four_ht:" + four_ht);
...
for (var i=0;i<tagArrLength;i++){
     var tagtemp = tagArray[i];
	if(tagtemp.text.indexOf(main_hashtag)!=-1){
	flag1=1;	
	}
}
if(flag1==1){
